...
def wave_ceptrum(waves, N, sample_rate):
    pow_spec = power_spectrum(waves)
...
def filterbank(filt_num, N, sample_rate=16000, low_freq=0, high_freq=None):
...
def get_wave_feature(waves, sample_rate):
    pass
